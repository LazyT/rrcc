...
SOURCES     += mainwindow.cpp history.cpp timer.cpp setup.cpp logger.cpp upload.cpp packager.cpp unpackager.cpp converter.cpp about.cpp zones.cpp installer.cpp uninstaller.cpp update.cpp download.cpp
HEADERS     += mainwindow.h   history.h   timer.h   setup.h   logger.h   upload.h   packager.h   unpackager.h   converter.h   about.h   zones.h   installer.h   uninstaller.h   update.h   download.h
